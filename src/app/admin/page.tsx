   ...
   return(   
      <>
        ...
        <div className="flex flex-col justify-center items-center text-center p-5 my-10">
            ...
            <Link href="/admin/registrar-membro" className="cursor-pointer bg-[var(--color-button-action)] transition duration-300 hover:bg-[var(--color-button-action-hover)] border-[var(--color-button-action-border)] border-2 rounded-2xl p-2 px-5 mt-5 min-w-[270px]">Adicionar Membro</Link>
        </div>
      </>
   )
}
